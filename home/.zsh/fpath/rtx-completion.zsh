...
'-g[Only show tool versions currently specified in a the global .tool-versions/.rtx.toml]' \
'--global[Only show tool versions currently specified in a the global .tool-versions/.rtx.toml]' \
...
(( $+functions[_rtx__help__sync__node_commands] )) ||
_rtx__help__sync__node_commands() {
    local commands; commands=()
    _describe -t commands 'rtx help sync node commands' commands "$@"
}
(( $+functions[_rtx__sync__help__node_commands] )) ||
_rtx__sync__help__node_commands() {
    local commands; commands=()
    _describe -t commands 'rtx sync help node commands' commands "$@"
}
(( $+functions[_rtx__sync__node_commands] )) ||
_rtx__sync__node_commands() {
    local commands; commands=()
    _describe -t commands 'rtx sync node commands' commands "$@"
}
