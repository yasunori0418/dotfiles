...
// Type definitions.
export type { ActionArguments } from "https://deno.land/x/ddu_vim@v3.5.0/types.ts";
export type { ConfigArguments } from "https://deno.land/x/ddu_vim@v3.5.0/base/config.ts";
