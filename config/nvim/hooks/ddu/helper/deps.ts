...
// Type definitions.
export type { ActionArguments } from "https://deno.land/x/ddu_vim@v3.4.6/types.ts";
export type { ConfigArguments } from "https://deno.land/x/ddu_vim@v3.4.6/base/config.ts";
