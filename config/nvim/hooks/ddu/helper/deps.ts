...
// Type definitions.
export type { ActionArguments } from "https://deno.land/x/ddu_vim@v3.4.1/types.ts";
export type { ConfigArguments } from "https://deno.land/x/ddu_vim@v3.4.1/base/config.ts";
