...
// Type definitions.
export type { ActionArguments } from "https://deno.land/x/ddu_vim@v3.4.4/types.ts";
export type { ConfigArguments } from "https://deno.land/x/ddu_vim@v3.4.4/base/config.ts";
