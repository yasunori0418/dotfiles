...
---@field public new fun(rule: { open: string, close: string, options?: table<string, string> }): AutoPairRule
local AutoPairRule = {}

---AutoPairRule initializer
---@param rule { open: string, close: string, options?: table<string, string> }
---@return AutoPairRule
